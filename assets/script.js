...
hamburgerIcon.forEach(index => {
	index.addEventListener("click", function () {
		if (hamburgerIcon[0].classList.contains("active")) {
			...
			hamburgerIcon[1].style.display = "block";
		} else {
			document.querySelector("html").style.overflowY = "";
			menuContainer.style.display = "";
			hamburgerIcon[0].classList.add("active");
			hamburgerIcon[1].style.display = "";
		}
	});
});
const headerMenuLinks = document.querySelectorAll(".link_header");

headerMenuLinks.forEach(index => {
