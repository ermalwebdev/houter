...
hamburgerOpenClose.addEventListener("click", function () {
	if (hamburgerIcon[0].classList.contains("active")) {
		...
		document.querySelector("html").style.top = "0px";
		document.querySelector("html").style.left = "0px";
		document.querySelector("html").style.right = "0px";
		...
		document.querySelector("html").style.right = "";
